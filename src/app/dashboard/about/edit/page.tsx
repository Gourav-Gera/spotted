        ...
        <div className="space-y-6">
          ...
          <div>
            <div className="rounded-xl border border-[#EDEDED] bg-white p-6 text-center shadow-sm">
              ...
              <input ref={fileInputRef} type="file" multiple accept="image/*" onChange={onFiles} className="hidden" />
              <button onClick={triggerUpload} type="button" className="inline-flex items-center gap-2 border-2 border-[#4A5D52] rounded-full px-6 py-2 text-md cursor-pointer text-[var(--primary)]">+ Upload Photo</button>
              {previews.length > 0 && (
