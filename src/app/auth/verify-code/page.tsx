    ...
    <div className="min-h-screen flex flex-col bg-[#FAFBFB]">
      ...
      <div className="flex-1 flex items-center justify-center p-6">
        <form onSubmit={onSubmit} className="card-surface max-w-md w-full text-center">
          ...
          <p className="text-sm text-[var(--gray)] mb-6">Enter the 4-digit code we sent to your email.</p>

          <div className="flex justify-center gap-3 mb-6">
            {[0,1,2,3].map(i=> (
              <input key={i} className="w-12 h-12 text-center border rounded-md" maxLength={1} />
            ))}
          </div>
